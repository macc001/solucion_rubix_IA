package rubik.grafico; // Anadido octubre-2008
...
public final class AnimCube extends Applet implements Runnable, MouseListener, MouseMotionListener {
  ...
  private Cubo cubo; // Anadido octubre-2008
  ...
  // JOptionPane.showMessageDialog(this, lastX+"   "+lastY);   /////////////***      
            toTwist = false;
    buttonPressed = selectButton(lastX, lastY);
    if (buttonPressed >= 0) {
       //  JOptionPane.showMessageDialog(this, " 1IF ENTRO MOUSEPRESED"); 
      pushed = true;
      if (buttonPressed == 3) {
        //  JOptionPane.showMessageDialog(this, " 2IF ENTRO MOUSEPRESED");
        if (!animating) // special feature
          ...
          //JOptionPane.showMessageDialog(this, " 3ELSE ENTRO MOUSEPRESED");
        stopAnimation();
        clear();
      }
      else if (buttonPressed == 7) { // next sequence
          // JOptionPane.showMessageDialog(this, " 4ELSE ENTRO MOUSEPRESED");
        stopAnimation();
        clear();
     ...
     //  JOptionPane.showMessageDialog(this, "5 ELSE ENTRO MOUSEPRESED");
        stopAnimation();
      ...
      if (editable && !animating &&
       ...
       (e.getModifiers() & InputEvent.SHIFT_MASK) == 0){
        toTwist = true;
      //  JOptionPane.showMessageDialog(this, " 5656ELSE ENTRO MOUSEPRESED");
      }
    }
  }

  public void mouseReleased(MouseEvent e) {//solo para hacer giros de de lineas
    ...
    if (pushed) {
      ...
      repaint();
       ...
       //  JOptionPane.showMessageDialog(this,"Giro un giro realset"); 
      twisting = false;
      ...
      repaint();
      // JOptionPane.showMessageDialog(this, "entro al repaint de realsed"); 
    }
  }
  ...
  public void mouseDragged(MouseEvent e) {
    if (pushed)
      return;
    if (dragging) {
        JOptionPane.showMessageDialog(this, " 1TAARRASTRAMDP");
      stopAnimation();
      int len = realMoveLength(move[curMove]);
      ...
      return;
         ...
         // JOptionPane.showMessageDialog(this, " 2TAARRASTRAMDP");// AQUI ENTRA CADA RATO
    ...
    System.out.println(x+" pos x  "+y);  //////////////aqui es don de **************cambia los drages
    
    if (editable && toTwist && !twisting && !animating) { // we do not twist but we can
            //   JOptionPane.showMessageDialog(this, " 3TAARRASTRAMDP"); //ENTRA CON EL CLICK IZQUIERDO
      lastDragX = x;
      lastDragY = y;
      System.out.println( x+"lasx  "+y+"  las y");
      for (int i = 0; i < dragAreas; i++) { // check if inside a drag area
        ...
        if (a > 0 && a < 1 && b > 0 && b < 1) { // we are in
          if (dx * dx + dy * dy < 144) // delay the decision about twisting
            return;
            //     JOptionPane.showMessageDialog(this, " 4TAARRASTRAMDP");
          dragX = dragDirsX[i];
          dragY = dragDirsY[i];
